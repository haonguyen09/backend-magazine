...
const createArticle = (newArticle, files) => {
    return new Promise(async (resolve, reject) => {
        ...
        const { title, content, user_id, submission_date, status, views, commentsCount, ratingsAverage, ratingsCount, topic_id, comments } = newArticle;
        ...
        try {
            ...
            // Check if documentPath is empty and set a default value
            if (!documentPath) {
                documentPath = 'path/to/default/document'; // Adjust this path to your requirements
            }
