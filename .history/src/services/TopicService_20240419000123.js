...
const getPaginationTopic = async (limit = 4, page = 0, filterFaculty, filterTitle) => {
    try {
        ...
        if (filterFaculty) {
            ...
            console.log("adkjash", queryConditions[filterFaculty[0]])
            console.log("adkjash", filterFaculty[1])
            console.log("adkjash", queryConditions[filterFaculty[0]] = filterFaculty[1])
        }
        if (filterTitle) {
