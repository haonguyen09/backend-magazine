    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            if (filterFaculty) {
                ...
                queryConditions.faculty_id = new mongoose.Types.ObjectId(filterFaculty);
            }
            if (filterTitle) {
            ...
            const totalFilter = await Topic.countDocuments({ ...queryConditions });
