...
const createTopic = async(req, res) => {
    try {
        ...
        const { title, description, startDate, closureDate, finalClosureDate, created_by} = req.body;
        
        if (!title || !description || !startDate || !closureDate || !finalClosureDate || !created_by) {
